...
export function Hero() {
    return (
        <section className="relative isolate overflow-hidden bg-[#120F17]">
            ...
            <div
              className="container-shell relative z-10 grid min-h-[720px] items-center gap-16 py-20 lg:grid-cols-[0.95fr_auto_1.05fr]"
            >
                {/* LEFT */}
            ...
            ">
                    ...
                    <p className="mt-8 max-w-[560px] text-[17px] leading-8 text-white/60">
                        ORB8 finds out why your venture isn't gaining traction. We diagnose where the
                        breakdown is happening, then turn real market and customer evidence into the
                        next experiment you should run.
                    </p>
                ...
                <div className="hidden h-[420px] w-px bg-white/10 lg:block" />
                  {/* RIGHT */}
                    ...
                    >
                      ...
                      <div className="mt-7">
                        ...
                        <p className="mt-3 max-w-[430px] text-[15px] leading-7 text-white/65">
                          Prospects understand the problem, but they don't understand why this
